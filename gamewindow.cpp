...
GameWindow::GameWindow() {
  ...
  QObject::connect(gameBoard, SIGNAL(playerScoreChanged(int)), playerScoresLabel, SLOT(setNum(int)));  //更新得分
  QObject::connect(gameBoard, SIGNAL(currentLevelChanged(int)), currentLevelLabel, SLOT(setNum(int)));  //更新等级
  QObject::connect(gameBoard, SIGNAL(linesRemovedChanged(int)), linesLabel, SLOT(setNum(int)));  //消除
